export default function HungerAnnouncement() {
  return (
    <section className="thought-of-day">
      <div className="thought-content announcement-card">
        ...
        <blockquote>
          ...
          <a href="https://ntfb.org" target="_blank" rel="noopener">
        ...
        <div className="thought-meta">
          <small>
            ...
            <a href="pages/hunger-in-texas.html">📋 Learn More &amp; RSVP</a> •{' '}
            <a href="/hunger-panel-event.ics" download>
              📅 Add to Calendar
            </a>
          </small>
        </div>
