...
export default function YoungScientists() {
  return (
      ...
      <article className="card">
        ...
        <div className="learning-resources">
          <div className="resource-links">
            <a href="https://www.youtube.com/watch?v=TsQL-sXZOLc" target="_blank" rel="noopener" className="resource-link video">
              How Sound Works (3 min)
            </a>
            <a href="https://www.youtube.com/watch?v=_2By2ane2I4" target="_blank" rel="noopener" className="resource-link video">
              Animal Hearing vs Human Hearing
            </a>
            <a href="https://images.unsplash.com/photo-1518709268805-4e9042af2176?w=600" target="_blank" rel="noopener" className="resource-link image">
              Frequency Chart
            </a>
          </div>
