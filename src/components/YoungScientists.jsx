      ...
      <article className="card">
        ...
        <div className="learning-resources">
          ...
          <div className="fun-facts">
            ...
            <ul>
              <li>
                <strong>Dogs hear:</strong> 67Hz to 45,000Hz
              </li>
              <li>
                <strong>Humans hear:</strong> 20Hz to 20,000Hz
              </li>
              <li>
                <strong>Elephants hear:</strong> Really low sounds we can't!
              </li>
              <li>
                <strong>Sound travels:</strong> about 343 meters per second
              </li>
            </ul>
          </div>
        </div>
