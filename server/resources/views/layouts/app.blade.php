...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .research-card { border-top: 4px solid var(--accent); } .research-eyebrow { color: var(--accent); font-size: 11px; font-weight: 700; letter-spacing: .1em; text-transform: uppercase; } .research-card h2 { margin-top: 8px; } .research-card h3 { margin: 28px 0 10px; font-size: 18px; } .research-question { font-style: italic; } .research-table-wrap { overflow-x: auto; } .research-table { width: 100%; border-collapse: collapse; font-size: 14px; line-height: 1.4; } .research-table th, .research-table td { padding: 10px 12px; border-bottom: 1px solid var(--border); text-align: left; vertical-align: top; } .research-table thead th { color: var(--muted); font-size: 11px; letter-spacing: .06em; text-transform: uppercase; } .research-table tbody th { width: 58%; font-weight: 500; } .research-table tbody td { color: var(--accent); font-weight: 700; white-space: nowrap; } .research-questions { margin: 0 0 16px 1.25rem; padding: 0; } .research-questions li { padding-left: 6px; margin-bottom: 10px; } .research-link { display: inline-block; margin-top: 8px; color: var(--accent); font-weight: 700; } .research-link:hover { text-decoration: underline; } .research-disclaimer { margin: 20px 0 0; color: var(--muted); font-size: 12px; line-height: 1.5; }
